...
- **Pobreza multidimensional:** las comunas tratadas sí mejoraron
  ...
  monetarias【961990098003751†L152-L156】.
...
- **Limitaciones:** el análisis no prueba causalidad; la muestra de
  ...
  influir en las tendencias de pobreza.

# Uso de IA generativa

En el desarrollo de este proyecto se utilizaron herramientas de
inteligencia artificial generativa (ChatGPT) para sugerir la
estructura del repositorio, redactar secciones y plantear ejemplos de
código.  Todas las decisiones analíticas, la selección de datos y la
interpretación de resultados fueron realizadas por el autor y se
basan en fuentes oficiales y artículos científicos sobre la creación
de áreas protegidas【696378958327625†L63-L67】
